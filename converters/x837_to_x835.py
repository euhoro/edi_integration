    ...
    cob_paid = \
        {
            "heading": {
                "transaction_set_header_ST": {
                    ...
                    "transaction_set_control_number_02": x837.detail.transaction_set_trailer_SE.transaction_set_control_number_02  # Unique transaction identifier
                },
                "financial_information_BPR": {
                    "transaction_handling_code_01": "I",  # I = Remittance info only
                    "total_actual_provider_payment_amount_02": str(secondary_payer[0].coordination_of_benefits_cob_payer_paid_amount_AMT.payer_paid_amount_02),# 39.15,  # Total payment to provider
                    "credit_or_debit_flag_code_03": "C",  # C = Credit
                    "payment_method_code_04": "CHK",  # CHK = Check payment OR ECTON
                    "check_issue_or_eft_effective_date_16": service_lines[0].line_adjudication_information_SVD_loop[0].line_check_or_remittance_date_DTP.adjudication_or_payment_date_03,#"2005-10-15"  # Date payment issued
                },
                "reassociation_trace_number_TRN": {
                    ...
                    "payer_identifier_03": secondary_payer[0].other_payer_name_NM1_loop.other_payer_name_NM1.other_payer_primary_identifier_09  # Payer's unique identifier
                },
                ...
                "production_date_DTM": {
                    ...
                    "production_date_02": service_lines[0].line_adjudication_information_SVD_loop[0].line_check_or_remittance_date_DTP.adjudication_or_payment_date_03 #"2005-10-15"  # Date of remittance creation
                },
                "payer_identification_N1_loop": {
                    "payer_identification_N1": {
                        "entity_identifier_code_01": "PR",  # PR = Payer
                        "payer_name_02": secondary_payer[0].other_payer_name_NM1_loop.other_payer_name_NM1.other_payer_organization_name_03 #"KEY INSURANCE COMPANY"  # Name of payer
                    },
                    "payer_address_N3": {
                        "payer_address_line_01": subscriber.payer_name_NM1_loop.payer_address_N3.payer_address_line_01 # ,"4456 SOUTH SHORE BLVD"  # Payer's address
                    },
                    "payer_city_state_zip_code_N4": {
                        "payer_city_name_01": subscriber.payer_name_NM1_loop.payer_city_state_zip_code_N4.payer_city_name_01, #"CHICAGO",  # City
                        "payer_state_code_02": subscriber.payer_name_NM1_loop.payer_city_state_zip_code_N4.payer_state_or_province_code_02,# "IL",  # State
                        "payer_postal_zone_or_zip_code_03": subscriber.payer_name_NM1_loop.payer_city_state_zip_code_N4.payer_postal_zone_or_zip_code_03#"44444"  # ZIP Code
                    },
                ...
                "payee_identification_N1_loop": {
                    "payee_identification_N1": {
                        ...
                        "payee_name_02":  bill_provider.billing_provider_name_NM1.billing_provider_last_or_organizational_name_03, #"KILDARE",  # Payee's name
                        "identification_code_qualifier_03": bill_provider.billing_provider_name_NM1.identification_code_qualifier_08 ,# "XX",  # XX = NPI (National Provider Identifier)
                        "payee_identification_code_04":bill_provider.billing_provider_name_NM1.billing_provider_identifier_09,# "1999996666"  # Payee's NPI
                    },
                    "payee_address_N3": {
                        "payee_address_line_01": bill_provider.billing_provider_address_N3.billing_provider_address_line_01#"1234 SEAWAY ST"  # Payee's address
                    },
                    "payee_city_state_zip_code_N4": {
                        "payee_city_name_01": bill_provider.billing_provider_city_state_zip_code_N4.billing_provider_city_name_01,#"MIAMI",  # City
                        "payee_state_code_02": bill_provider.billing_provider_city_state_zip_code_N4.billing_provider_state_or_province_code_02,#"FL",  # State
                        "payee_postal_zone_or_zip_code_03": bill_provider.billing_provider_city_state_zip_code_N4.billing_provider_postal_zone_or_zip_code_03#"33111"  # ZIP Code
                    },
                    "payee_additional_identification_REF": [
                        {
                            "reference_identification_qualifier_01": bill_provider.billing_provider_tax_identification_REF.reference_identification_qualifier_01, #"EI",  # EI = Employer ID
                            "additional_payee_identifier_02": bill_provider.billing_provider_tax_identification_REF.billing_provider_tax_identification_number_02 # "123456789"  # Employer ID number
                        }
                    ]
                }
            },
                                ...
                                "service_payment_information_SVC_loop": [
                                    {
                                        "service_payment_information_SVC": {
                                            ...
                                            "line_item_provider_payment_amount_03": 40.00,
