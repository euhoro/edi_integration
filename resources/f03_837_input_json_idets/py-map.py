...
def transform_service_line_number_LX_loop(service_lines_raw):
    ...
    #svd = [x for x in service_lines_raw if  'line_adjudication_information_SVD_loop' in ads]
    #remitance = [x['line_adjudication_information_SVD_loop']['line_check_or_remittance_date_DTP'] for x in ads if 'date_time_qualifier_01' in x['line_adjudication_information_SVD_loop']['line_check_or_remittance_date_DTP']  ]
...
def main():
    ...
    with open("/Users/eugenhoro/PycharmProjects/github/edi_integration/resources/f03_837_input_json_idets/X222-COB-claim-from-billing-provider-to-payer-b.after_mapping_837.json", "r") as file:
        data = json.load(file)
    ...
    with open("/Users/eugenhoro/PycharmProjects/github/edi_integration/resources/f03_837_input_json_idets/X222-COB-claim-from-billing-provider-to-payer-b.after_mapping_837c.json", "w") as file:
